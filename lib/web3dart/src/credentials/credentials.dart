...
class Web3PrivateKey extends CredentialsWithKnownAddress {
  ...
  Web3PrivateKey.fromHex(String hex) : this(hexToBytes(hex));

  /// Creates a private key from the underlying number.
  Web3PrivateKey.fromInt(this.privateKeyInt)
  ...
  /// use [Random.secure()].
  factory Web3PrivateKey.createRandom(Random random) {
    final key = generateNewPrivateKey(random);
    return Web3PrivateKey(intToBytes(key));
  }
